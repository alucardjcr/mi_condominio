// Ronda 58, a pedido explícito del usuario: selector real de región/comuna
// al crear un condominio (antes texto libre) — se elige la región primero
// y la lista de comunas se filtra sola a esa región. Datos verificados
// contra fuentes oficiales (SUBDERE / Wikipedia) — 16 regiones, 346
// comunas en total.
...
export const REGIONES_CHILE: RegionChile[] = [
  ...
  },
  {
    ...
    comunas: [
      ...
      "Limache", "Quilpué", "Villa Alemana", "Olmué",
    ],
  },
  {
  ...
  },
  {
    ...
    comunas: [
      ...
      "Antártica", "Porvenir", "Primavera", "Timaukel", "Puerto Natales", "Torres del Paine",
    ],
  },
];
