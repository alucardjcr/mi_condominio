...
const styles = StyleSheet.create({
  ...
  limpiarEstado: { color: "#1a6fc4", fontSize: 12, marginTop: 4 },
  boton: { backgroundColor: "#333", borderRadius: 10, padding: 14, alignItems: "center", marginTop: 16 },
  botonTexto: { color: "#fff", fontSize: 16, fontWeight: "700" },
  totalGeneral: { marginTop: 12, fontSize: 14, fontWeight: "700", color: "#1a6fc4" },
  ...
  estado: { fontSize: 12, color: "#1a6fc4", fontWeight: "700" },
